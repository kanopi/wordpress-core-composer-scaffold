...
use WordPress\Composer\Plugin\Scaffold\Operations\OperationInterface;
...
class ScaffoldFileInfo {
   ...
   *
   * @var \WordPress\Composer\Plugin\Scaffold\Operations\OperationInterface
   */
  protected $op;
   ...
   *   defining it.
   * @param \WordPress\Composer\Plugin\Scaffold\Operations\OperationInterface $op
   ...
   *
   * @return \WordPress\Composer\Plugin\Scaffold\ScaffoldFilePath
   ...
   * @param \WordPress\Composer\Plugin\Scaffold\ScaffoldOptions $options
