 ...
 * data is pulled from the 'wordpress-scaffold' portion of the extras section of
 * the project data.
 *
 * @internal
 */
class ScaffoldOptions {
   ...
   *
   * @param array $options
   *   The scaffold options taken from the 'wordpress-scaffold' section.
   */
  ...
  public static function hasOptions(array $extras) {
    return array_key_exists('wordpress-scaffold', $extras);
  }
  ...
  public static function create(array $extras) {
    $options = static::hasOptions($extras) ? $extras['wordpress-scaffold'] : [];
