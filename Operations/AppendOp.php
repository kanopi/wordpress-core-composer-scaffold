...
class AppendOp extends AbstractOperation {
   ...
   *
   * @param \WordPress\Composer\Plugin\Scaffold\ScaffoldFilePath $prepend_path
   *   The relative path to the prepend file.
   * @param \WordPress\Composer\Plugin\Scaffold\ScaffoldFilePath $append_path
   *   The relative path to the append file.
   * @param bool $force_append
   *   TRUE if is okay to append to a file that was not scaffolded.
   * @param \WordPress\Composer\Plugin\Scaffold\ScaffoldFilePath $default_path
   ...
   * @param \WordPress\Composer\Plugin\Scaffold\ScaffoldFilePath $data_path
