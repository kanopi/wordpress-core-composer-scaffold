...
use WordPress\Composer\Plugin\Scaffold\Interpolator;
use WordPress\Composer\Plugin\Scaffold\ScaffoldFileInfo;
...
class ScaffoldFileCollection implements \IteratorAggregate {
   ...
   *
   * @var \WordPress\Composer\Plugin\Scaffold\ScaffoldFileInfo[][]
   */
   ...
   *
   * @param \WordPress\Composer\Plugin\Scaffold\Operations\OperationInterface[][] $file_mappings
   *   A multidimensional array of file mappings.
   * @param \WordPress\Composer\Plugin\Scaffold\Interpolator $location_replacements
   ...
   *
   * @param WordPress\Composer\Plugin\Scaffold\ScaffoldFileInfo[] $scaffold_files
   ...
   * @param \WordPress\Composer\Plugin\Scaffold\ScaffoldOptions $scaffold_options
   ...
   *
   * @param \WordPress\Composer\Plugin\Scaffold\Operations\ScaffoldFileCollection $collection
   ...
   *   in 8.9.x or 9.x, and remove in WordPress 10.x.
   */
   ...
   * two. @see https://www.wordpress.org/project/wordpress/issues/3092563
   *
   * @return string[]
